    ...
    await transporter.sendMail({
      ...
      html: `
        <div style="font-family:sans-serif;max-width:600px;padding:24px;background:#0a0907;color:#f5e6d3;border-radius:12px;">
          <h2 style="color:#d4a574;margin-bottom:16px;">New Portfolio Enquiry</h2>
    ...
    await transporter.sendMail({
      ...
      html: `
        <div style="font-family:sans-serif;max-width:600px;padding:24px;background:#0a0907;color:#f5e6d3;border-radius:12px;">
          ...
          <p style="color:#a8997f;">In the meantime, feel free to connect on <a href="https://www.linkedin.com/in/aashish-yadav-679a81217" style="color:#d4a574;">LinkedIn</a> or WhatsApp me at <a href="https://wa.me/917489838868" style="color:#d4a574;">+91 7489838868</a>.</p>
